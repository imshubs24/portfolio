...
const About = () => {
    return (
        <>
            <div id="about" className='h-dvh relative bg-[#030610] flex flex-col justify-center'>
                <h2 className='mb-8 text-5xl lg:mx-40 md:mx-20 sm:mx-5 text-white max-sm:mx-2 select-none'>About</h2>
