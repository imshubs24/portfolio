        ...
        <div id="skills-section" className='flex flex-col h-full gap-y-12 items-center select-none w-full'>
          ...
          <div id="skills-row" className='grid 2xl:grid-cols-5 gap-y-12 lg:grid-cols-3 xl:grid-cols-3 sm:grid-cols-2 md:w-5/6 sm:w-full xl:w-2/3 p-14 place-items-center'>
            ...
            <div id="skills2" className='h-44 w-56 relative'>
              ...
              <div className='w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' style={{ width: 175 }}>
                <CircularProgressbar value={45} strokeWidth={4}
                  styles={buildStyles({
                    strokeLinecap: 'round',
                    textSize: '16px',
                    pathTransitionDuration: 2,
                ...
                <div id="inner-value" className='absolute top-[60%] left-1/2 transform -translate-x-1/2 -translate-y-1/2'>45%</div>
              </div>
            </div>
            <div id="skills3" className='h-44 w-56 relative'>
              ...
              <div className='w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' style={{ width: 175 }}>
                <CircularProgressbar value={46} strokeWidth={4}
                  styles={buildStyles({
                    strokeLinecap: 'round',
                    textSize: '16px',
                    pathTransitionDuration: 2,
                ...
                <div id="inner-value" className='absolute top-[60%] left-1/2 transform -translate-x-1/2 -translate-y-1/2'>46%</div>
              </div>
            </div>
            <div id="skills4" className='h-44 w-56 relative'>
              ...
              <div className='w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' style={{ width: 175 }}>
                <CircularProgressbar value={25} strokeWidth={4}
                  styles={buildStyles({
                    strokeLinecap: 'round',
                    textSize: '16px',
                    pathTransitionDuration: 2,
                ...
                <div id="inner-value" className='absolute top-[60%] left-1/2 transform -translate-x-1/2 -translate-y-1/2'>25%</div>
              </div>
            </div>
