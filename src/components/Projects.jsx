...
const projectData = [
  ...
  { id: 'project3', url: 'https://github.com/slokhande310/TaskManagementBackend', name: 'Task Management Backed', imgSrc: sample, details: `Built with Node.js, it features user authentication, allowing sign-up and log-in, and supports CRUD operations` },
  ...
  { id: 'project6', url: 'https://amazonclone-slokhande.netlify.app/', name: 'Amazon India Clone', imgSrc: sample, details: 'Beginner Friendly Amazon India Clone Website using HTML & CSS only' },
];
      ...
      <div className='flex flex-col items-center gap-y-12 max-md:gap-y-6'>
        ...
        <div className={`h-full w-auto grid lg:grid-cols-3 place-items-center p-14 max-sm:p-4 max-sm:gap-3 max-lg:gap-16 lg:gap-8 md:grid-cols-2 sm:grid-cols-1`} id='projects-grid'>
          {projectData.map((project) => (
            <div key={project.id} className='relative min-h-60 min-w-60 max-w-60 max-md:w-[80%] max-md:place-items-center max-md:max-w-96 group select-none' style={{ backgroundImage: `url(${project.imgSrc})`, backgroundSize: 'cover', backgroundPosition: 'left', backgroundRepeat: 'no-repeat' }}>
