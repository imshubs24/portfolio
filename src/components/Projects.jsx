  ...
  return (
    <div className='h-dvh max-lg:h-auto bg-[#030610] w-full items-center relative text-white' id='projects'>
      <div className=' flex flex-col items-center'>
        <h2 className='mt-28 mb-10 text-5xl select-none'>Projects</h2>
        <div className='h-auto w-auto grid lg:grid-cols-3 place-items-center lg: p-14 max-sm:p-4 max-sm:gap-3 max-lg:gap-16 lg:gap-8 md:grid-cols-2 sm:grid-cols-1' id="projects-grid">
